...
// Add Todos
exports.addPrstodolist = async (req, res) => {
  try {
    const {
    task,
    description,
...
exports.getPrstodolistById = async (req, res) => {
  try {
...
// delete Todo
exports.deletePrstodolist = async (req, res) => {
  try {
    const todos = await Todos.findById(req.params.id);
    if (!todos) {
      return res.status(404).json({ error: "Todos not found" });
...
// Update Prstodolist by ID
exports.updatePrstodolist = async (req, res) => {
  try {
    const {
    task,
    description,
...
exports.updateImportantprstodolist = async (req, res) => {
  try {
    const todos = await Todos.findById(req.params.id);
    if (!todos) {
      return res.status(404).json({ error: "Todos not found" });
...
exports.updateTaskdoneprstodolist = async (req, res) => {
  try {
    const todos = await Todos.findById(req.params.id);
    if (!todos) {
      return res.status(404).json({ error: "Todos not found" });
...
exports.updateTaskdoneRemoveprstodolist = async (req, res) => {
  try {
    const todos = await Todos.findById(req.params.id);
    if (!todos) {
      return res.status(404).json({ error: "Todos not found" });
...
// Revive Todo
exports.revivePrstodolist = async (req, res) => {
  try {
    const todos = await Todos.findById(req.params.id);
    if (!todos) {
      return res.status(404).json({ error: "Todos not found" });
...
exports.permanentdeletePrstodolist = async (req, res) => {
  try {
...
exports.priorityPrstodolist = async (req, res) => {
  try {
    const {
    priority
    } = req.body;
