...
const BudgetQtrSchema = new mongoose.Schema({
...
// 👇 This hook generates the 4-digit budgetQtrId
BudgetQtrSchema.pre('save', async function (next) {
  if (this.isNew) {
    try {
...
module.exports = mongoose.model('BudgetQtr', BudgetQtrSchema);
